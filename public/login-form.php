        ...
        <div class="login-card">
            <form method="POST">  
                ...
                <div class="pmd-card-footer card-footer-no-border card-footer-p16 text-center">
                    ...
                    <br>
                    <br>
                    <span class="pmd-card-subtitle-text">Tims &copy; <span class="auto-update-year"></span>. All Rights Reserved.</span>
            <h3 class="pmd-card-subtitle-text"><a href="https://codecanyon.net/item/ecommerce-online-shop-app/10442576" target="_blank">Version 3.0.1</a></h3>
